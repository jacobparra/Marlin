...
#define STRING_CONFIG_H_AUTHOR "(jacobparra, Ender-3 Pro)" // Who made the changes.
 ...
 */
#define PSU_CONTROL
#define PSU_NAME "BIGTREETECH Relay V1.2"
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 78.10
  #define DEFAULT_bedKi 12.52
  #define DEFAULT_bedKd 325.0
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -41, -2, 0 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 117  // (mm) X point for Z homing - bed center (235mm / 2)
  #define Z_SAFE_HOMING_Y_POINT 117  // (mm) Y point for Z homing - bed center (235mm / 2)
#endif
...
#define NOZZLE_PARK_POINT {X_MAX_POS, Y_MAX_POS, 10}
