...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp  133.90
  #define DEFAULT_bedKi   23.91
  #define DEFAULT_bedKd  499.80
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION
    ...
    #define G26_XY_FEEDRATE         10    // (mm/s) Feedrate for G26 XY moves.
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 34, 34, 34, 34 } // (mm) Left, Front, Right, Back insets
