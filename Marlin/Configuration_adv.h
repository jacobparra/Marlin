...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  30, 34 }, { 201,  34 }, { 201, 201 }, { 30, 201 } }
...
// LCD Print Progress options
  ...
  #define EVENT_GCODE_SD_ABORT "G10\nG91\nG1 Z10\nG90\nG1 X0 Y235 F9000"      // G-code to run on SD Abort Print (e.g., "G28XY" or "G27")
...
//#define MECHANICAL_GANTRY_CALIBRATION
  ...
  #define GANTRY_CALIBRATION_CURRENT          290     // Default calibration current in ma
  #define GANTRY_CALIBRATION_EXTRA_HEIGHT      5     // Extra distance in mm past Z_###_POS to move
